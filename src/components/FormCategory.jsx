        ...
        >
          ...
          <div className="flex flex-row justify-center gap-4 pt-6">
            <button
              ...
              className="bg-amber-950 hover:bg-amber-950 text-amber-100 px-6 py-3 rounded-md flex items-center justify-center flex-1 text-center"
            >
              Volver
            </button>
            <button
              type="submit"
              className="bg-amber-950 hover:bg-amber-950 text-amber-950 px-6 py-3 rounded-md flex items-center justify-center flex-1 text-center"
            >
              Enviar
            </button>
          </div>
